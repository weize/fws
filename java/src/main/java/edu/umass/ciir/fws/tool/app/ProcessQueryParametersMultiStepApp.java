 ...
 * @author wkong
 */
public abstract class ProcessQueryParametersMultiStepApp extends AppFunction {
    ...
    private Stage getProcessStage(Parameters parameters) {
        ...
        for (Class klass : getProcessClasses()) {
            stage.add(new Step(klass, parameters));
        }
        return stage;
    }
     ...
     * @return
     */
    protected abstract List<Class> getProcessClasses();
}
