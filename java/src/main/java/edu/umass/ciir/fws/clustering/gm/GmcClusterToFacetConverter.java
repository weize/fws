...
public class GmcClusterToFacetConverter extends StandardStep<TfQueryParameters, TfQueryParameters> {

    String facetDir;
    String clusterDir;

    public GmcClusterToFacetConverter(TupleFlowParameters parameters) {
        Parameters p = parameters.getJSON();
        facetDir = p.getString("gmcFacetDir");
    ...
    public void process(TfQueryParameters queryParams) throws IOException {
        ...
        File facetFile = new File(Utility.getFacetFileName(facetDir, queryParams.id, "gmc", ranker));
